    ...
    <section class="container_list_user">
        ...
        <table>
            ...
            <?php
                ...
                $query = mysqli_query($conection, "SELECT f.nofactura, f.fecha, f.totalfactura, f.codcliente, f.estatus, u.nombre AS vendedor, cl.nombre AS cliente FROM factura AS f INNER JOIN usuario AS u ON f.usuario = u.idusuario INNER JOIN cliente AS cl ON f.codcliente = cl.idcliente WHERE f.estatus != 10 ORDER BY f.fecha DESC LIMIT $desde, $por_pagina;");
