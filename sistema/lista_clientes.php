        ...
        <table>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <a class="link_edit" href="editar_cliente.php?id=<?php echo($data["idcliente"]);?>"><i class="fa-solid fa-pen-to-square" style="color: #74C0FC;"></i> Editar</a>
                        ...
                        <?php
                            ...
                            {
                        ?>
                        <a class="link_delete" href="eliminar_confirmar_cliente.php?id=<?php echo($data["idcliente"]);?>"><i class="fa-solid fa-trash-can" style="color: #ff0000;"></i> Eliminar</a>
                        <?php 
                            } 
                        ?>
                    </td>
